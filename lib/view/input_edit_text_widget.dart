...
class _InputEditTextWidgetState extends BaseState<InputEditTextWidget> {
  String _inputText = "";
            ...
            child: Container(
              child: TextField(
                ...
                controller: TextEditingController.fromValue(
                  TextEditingValue(
                    text: _inputText,
                    selection: TextSelection.fromPosition(TextPosition(affinity: TextAffinity.downstream, offset: _inputText.length)),
                  ),
                ),
